...
begin
  ...
  RunSimulation(x, z, G1Edit.Value, G2Edit.Value, T0Edit.Value, iterations);
  ...
  begin
    ...
    ValuesGrid.Cells[4, i + 1] := FloatToStrF(gValues.v[i], ffFixed, 0, 4);
    ValuesGrid.Cells[5, i + 1] := FloatToStrF(gValues.y[i], ffFixed, 0, 4);
    ValuesGrid.Cells[6, i + 1] := FloatToStrF(gValues.ys[i], ffFixed, 0, 4);
    ValuesGrid.Cells[7, i + 1] := FloatToStrF(gValues.yr[i], ffFixed, 0, 4);
  end;
  PlotForm.ShowPlot;
  gValues.Destroy;
end;
