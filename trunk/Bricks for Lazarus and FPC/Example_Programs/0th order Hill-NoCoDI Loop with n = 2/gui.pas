...
begin
  ...
  PredictionForm.DisplayPrediction(gPrediction1, gPrediction2, gPrediction3);
  ...
  begin
    ...
    ValuesGrid.Cells[2, i + 1] := FloatToStrF(gValues.e[i], ffFixed, 0, 4);
    ValuesGrid.Cells[3, i + 1] := FloatToStrF(gValues.c[i], ffFixed, 0, 4);
    ValuesGrid.Cells[4, i + 1] := FloatToStrF(gValues.u[i], ffFixed, 0, 4);
    ValuesGrid.Cells[5, i + 1] := FloatToStrF(gValues.y[i], ffFixed, 0, 4);
